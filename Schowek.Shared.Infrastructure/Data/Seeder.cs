        ...
        private IEnumerable<Catalog> GetCatalogs()
        {
            var catalogs = new List<Catalog>()
            {
                ...
                new Catalog()
                {
                    ...
                    CatalogColor = Domain.Models.Enums.Colors.Yellow,
                    Items = new List<Item>()
                    {
                        new Item()
                        {
